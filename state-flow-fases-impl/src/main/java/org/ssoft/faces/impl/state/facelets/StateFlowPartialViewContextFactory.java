 ...
 */
public class StateFlowPartialViewContextFactory extends PartialViewContextFactory {
    ...
    public PartialViewContext getPartialViewContext(FacesContext context) {
        return new StateFlowPartialViewContext(wrapped.getPartialViewContext(context));
    }
